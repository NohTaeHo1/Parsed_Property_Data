...
#
# output_file = 'scripts/pythonProject/officetel_transaction/officetel_transaction_test.xml'
...
for k in range(5):
    ...
    # 데이터 파일로 저장
    output_file = f'scripts/pythonProject/officetel_transaction/parsed_data/officetel_trade_{dear_ymd}.csv'
